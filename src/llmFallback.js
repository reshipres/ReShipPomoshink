    ...
    if (ids.has('warranty_policy') && /(гарант|возврат|обмен|брак|дефект|вернуть|слом)/i.test(text)) {
      return {
        ...
        action: /брак|дефект|слом|обмен|вернуть|возврат/i.test(text)
          ? 'handoff_to_operator'
          : 'answer',
        answer: 'Гарантия и возврат зависят от товара и ситуации. Возврат товара надлежащего качества возможен в течение 7 дней при сохранении товарного вида и упаковки. Брак, повреждение, обмен или спорный случай передам оператору.',

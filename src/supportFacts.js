...
export const SUPPORT_FACTS = [
  ...
  },
  {
    ...
    keywords: ['гарантия', 'возврат', 'обмен', 'брак', 'сломано', 'дефект', 'вернуть'],
  ...
  },
  {
    ...
    keywords: ['наличие', 'есть', 'товар', 'модель', 'цена', 'стоимость', 'аналог', 'похожее', 'оформить'],
    text: 'Наличие, цена, остатки и ссылка на оформление должны проверяться по базе товаров ReShip. Если товара нет в базе или найдено несколько вариантов, нужно попросить ссылку, артикул, точную модель или передать оператору.',
  },
  {
    id: 'preorder_policy',
  ...
  },
  {
    ...
    intents: ['order_status', 'order_lookup_followup', 'order_switch'],
    keywords: ['заказ', 'статус', 'трек', 'накладная', 'номер', 'телефон', 'фамилия', 'получатель'],
    text: 'Заказ можно искать по номеру заказа, CRM-номеру, треку CDEK, телефону или фамилии/ФИО получателя. Если найдено несколько заказов, нельзя угадывать: нужно запросить точный номер, трек, полное ФИО или уточнение.',
  },
  {
    id: 'handoff_policy',
    ...
    keywords: ['оператор', 'менеджер', 'человек', 'изменить', 'отменить', 'ошибка', 'брак', 'возврат', 'снг', 'международная'],
    text: 'Оператор нужен для изменения заказа, спорной оплаты, ошибок сайта, доставки по СНГ/за рубеж, внешних ссылок и ручного расчета, брака, возврата, обмена, претензий и случаев, где клиент сам просит человека.',
  },
];

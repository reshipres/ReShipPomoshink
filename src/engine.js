...
function routeDecision(classified, message, context) {
  ...
  switch (classified.intent) {
    ...
    case INTENTS.PRODUCT_ADVICE:
      ...
      return ask('product_advice', 'Каталог ReShip: https://reship.pro. Помогу с выбором: напишите, что ищете — мышку, коврик, клавиатуру, глайды, свитчи или аксессуары. Если нужна конкретная модель, пришлите название или ссылку, проверю наличие и цену.', [
        'Проверить наличие',
        'Сколько доставка?',
        'Позови оператора',

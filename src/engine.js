...
function routeDecision(classified, message, context) {
  ...
  switch (classified.intent) {
    case INTENTS.GREETING:
      return answer('greeting', 'Привет! Я помощник ReShip. Помогу выбрать товар, проверить наличие и цену, подсказать доставку, оплату или самовывоз. Если заказ уже оформлен, могу найти его по номеру, треку CDEK, телефону или ФИО получателя.', [

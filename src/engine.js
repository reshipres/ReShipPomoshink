...
function routeDecision(classified, message, context) {
  ...
  switch (classified.intent) {
    case INTENTS.GREETING:
      return answer('greeting', 'Привет! Я помощник ReShip. Если вы впервые у нас, помогу выбрать товар, проверить наличие и цену, разобраться с доставкой, оплатой, самовывозом и оформлением. Если заказ уже есть, найду его по номеру, треку CDEK, телефону, email или ФИО получателя.', [
        'Что есть в наличии?',
        'Как доставляете?',
        'Как оформить заказ?',
